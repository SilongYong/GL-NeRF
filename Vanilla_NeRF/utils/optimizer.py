...
class LinearWarmupCosineAnnealingLR(_LRScheduler):
    """Taken from https://github.com/Lightning-AI/lightning-bolts/blob/master/pl_bolts/optimizers/lr_scheduler.py
...
def make_optimizer(params,
    ...
    update_scheduler_interval = 'epoch'
    lr_scheduler = None
    if scheduler == 'step':
        assert 'milestones' in kwargs
        lr_scheduler = MultiStepLR(optimizer, kwargs['milestones'])
        ...
        update_scheduler_interval = 'step'
    elif scheduler == 'warmup_cosine':
        lr_scheduler = LinearWarmupCosineAnnealingLR(
            optimizer, kwargs['warmup_epochs'],
            kwargs['max_epochs'],
            warmup_start_lr=kwargs['warmup_start_lr'],
            eta_min=0.0,
            last_epoch=-1)
    return optimizer, lr_scheduler, update_scheduler_interval